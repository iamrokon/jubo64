                      ...
                      <tbody>
                        ...
                        if ($_GET['dist_id'] == $_SESSION['id']) {
                          ...
                          if (isset($_GET['dist_id']) || isset($_GET['batch_id']) || isset($_GET['group_id'])) {
                            ...
                            if ($distId && $batch && $group) {
                              $sql = mysqli_query($con, "SELECT student_list.student_id, student_list.stu_name, student_list.father_name,student_list.contact,student_list.gender,student_list.userPic, income_info.earning_dollar, income_info.earning_bd FROM student_list 
                        ...
                        ?>
                                <tr>
                                  ...
                                  <td><?= $row['earning_dollar'] ?? '-'; ?></td> 
                                  <td><?= $row['earning_bd'] ?? '-'; ?></td>
                                  <td><?= $row['contact']; ?></td>
                                  <td><?= $row['gender']; ?></td>
