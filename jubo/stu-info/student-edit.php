...
<body data-topbar="colored">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="StuName" required value="<?php echo $stu_name; ?>" />
                          </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            ...
                            <input style="width: 100%;" class="form-control" name="FatherName" required value="<?php echo $father_name; ?>">
                          </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="MotherName" required value="<?php echo $mother_name; ?>" />
                          </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="date" name="Dob" required value="<?php echo $birth_date; ?>" />
                          </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="Age" required value="<?php echo $age; ?>" />
                          </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="tel" name="Contact"  value="<?php echo $contact; ?>" />
                          </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="NidNo" value="<?php echo $nid_no; ?>" />
                          </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="BloodGrp" required value="<?php echo $blood_grp; ?>" />
                          </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            ...
                            <select class="form-control" type="text" name="Computer" required>
                        ...
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="PassYear" value="<?php echo $pass_year; ?>" />
                          </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="url" name="Linkedin" value="<?php echo $linked_in; ?>" />
                          </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="url" name="Upwork" value="<?php echo $upwork; ?>" />
                          </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="url" name="Fiverr" value="<?php echo $fiver; ?>" />
                          </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="url" name="LinkThree" value="<?php echo $link_three; ?>" />
                          </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="url" name="LinkFour" value="<?php echo $link_four; ?>" />
                          </div>
                        </div>
  ...
  <div class="form-group">
    ...
    <p>
      <img id="preview-image" src="user_images/<?php echo $userPic; ?>" class="img-fluid img-thumbnail rounded-circle" style="width: 150px; height: 150px;" />
    </p>
