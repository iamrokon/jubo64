                      ...
                      <tbody>
                        ...
                        if ($_GET['dist_id'] == $_SESSION['id']) {
                          ...
                          if (isset($_GET['dist_id']) || isset($_GET['batch_id']) || isset($_GET['group_id'])) {
                            ...
                            if ($distId && $batch && $group) {
                              ...
                              WHERE student_list.status = 1 AND student_list.district = '$distId' AND student_list.batch_id= '$batch' AND student_list.group_id= '$group' ORDER BY student_list.student_id ASC");


                            } elseif ($distId && $batch) {
                              $sql = mysqli_query($con, "SELECT student_list.student_id, student_list.stu_name, student_list.father_name,student_list.contact,student_list.gender,student_list.userPic, student_list.upwork, student_list.fiver FROM student_list 
                               WHERE student_list.status = 1 AND student_list.district = '$distId' AND student_list.batch_id= '$batch' ORDER BY student_list.student_id ASC");
                            }
                        ...
                        ?>
                              ...
                              ?>
                                 ...
                                 <td>
  <img src="user_images/<?= $row['userPic']; ?>" 
       onerror="this.onerror=null; this.src='../student-panel/user_images/<?= $row['userPic']; ?>';" 
