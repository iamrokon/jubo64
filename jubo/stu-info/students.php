                      ...
                      <form action="earning-information-report" method="post" target="_blank">
                        <div class="row align-items-center justify-content-center">
                          ...
                          <div class="col-md-6 col-lg-3 col-xxl-2 my-2">
                            <a id="reportLink" name="submit" target="_blank"
                              class="btn btn-success w-100 waves-effect">Open Report</a>
                          </div>
                    ...
                    <table id="datatable" class="table table-bordered table-hover align-middle">
                      ...
                      <tbody>
                        ...
                        $query = "SELECT student_list.*, batch_list.batch_name, group_list.group_name
                                  ...
                                  WHERE student_list.status = 1 AND student_list.user_id = " . $_SESSION['id'] . " ORDER BY student_list.student_id desc";
                        ...
                        while ($row = $result->fetch_assoc()) {
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              } elseif (file_exists('../student-panel/user_images/' . $row["userPic"])) {
                                echo '<img src="../student-panel/user_images/' . $row["userPic"] . '" class="img-fluid img-thumbnail rounded-circle" style="width:40px; height: 40px;" />';
                              } else {
                            ...
                            <td width="10%">
                              <a class="btn btn-success waves-effect"
                                href="student-edit?edit_id=<?= $row['student_id']; ?>" title="click for edit"><i
                                  class="fa fa-edit"></i></a>
                              <a class="btn btn-primary waves-effect"
                                href="student-view?view_id=<?= $row['student_id']; ?>" title="Click To View"><i
                                  class="fa fa-eye"></i></a>
                              <a class="btn btn-danger waves-effect" href="?delete_id=<?= $row['student_id']; ?>"
                                title="click for delete" onclick="return confirm('Are You Sure....?')"><i
