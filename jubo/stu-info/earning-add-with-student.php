...
<body data-topbar="colored">
  ...
  if (isset($_POST['submit'])) {
    ...
    $upload_dir = '../stu-info/income_images/'; // upload directory
                      ...
                      <div class="col-md-5">
                        <form method="post" enctype="multipart/form-data">
                          ...
                          <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="StudentID" id="StudentID" value="<?= $eqrow['student_id'] ?>" readonly placeholder="Enter student ID number" required>
                            <input type="text" class="form-control" name="StuUserID" id="StudentID" value="<?= $eqrow['stu_user_id'] ?>" readonly placeholder="Enter student ID number" required>
                          </div>
