...
<div class="container-fluid">
  ...
  <table width="100%" class="table m-0 table-bordered" id="dataTables-example">
   ...
   <th>Earning Dollar</th>
    ...
    $query = "SELECT DISTINCT student_list.stu_name, student_list.gender, student_list.father_name, student_list.contact, student_list.fiver, student_list.upwork,
          district.dist_name, student_list.student_id, batch_list.batch_name, income_info.earning_dollar, income_info.earning_bd, work_source.work_name, jobs.job_name
          FROM student_list
          ...
          WHERE student_list.batch_id = 12
        ...
        while ($eqrow = mysqli_fetch_assoc($eq)) {
          ...
          <tr>
            ...
            <td><?= htmlspecialchars($eqrow['stu_name']); ?></td>
              <td><?= htmlspecialchars($eqrow['batch_name']); ?></td>
