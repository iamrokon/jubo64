                    ...
                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                      ...
                      <tbody>
                        ...
                        if(mysqli_num_rows($checkTable) > 0) {
                            $query = mysqli_query($con, "SELECT branch_distances.*, district.dist_name FROM branch_distances LEFT JOIN district ON branch_distances.branch_id = district.id ORDER BY branch_distances.id DESC");
                        ...
                        <tr>
                          ...
                          <td><?= $row['location_name'] ?? 'Main Center' ?></td>
                          <td><?= $row['lat'] ?></td>
                          <td><?= $row['lng'] ?></td>
                          <td><?= $row['radius'] ?></td>
                          <td>
