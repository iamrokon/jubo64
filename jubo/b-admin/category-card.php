  ...
  <div class="row g-3 justify-content-center align-items-stretch">
      ...
      <i class="fa-solid fa-dollar-sign"></i> 1,52,329
        ...
        data-target="<?php
          ...
          <div class="d-flex justify-content-center align-items-baseline">
            ...
            <h4 class="fw-bold mb-1 pl-1 text-dark" id="counter5" data-target="972338">
    ...
    0
          ...
          <div class="d-flex justify-content-center align-items-baseline">
            ...
            <h4 class="fw-bold mb-1 pl-1 text-dark" id="counter6" data-target="39917197">
              0
            </h4>
          </div>
      ...
      <div class="card text-white text-center h-100 shadow-sm" style="background-color: #d1ecf1;">
        <div class="card-body">
         ...
         1512(60%)
          ...
          <h4 class="fw-bold mb-1 text-dark" id="counter7" data-target="5858">0 (55%)</h4>

          <script>
            document.addEventListener("DOMContentLoaded", function() {
              const counter7 = document.getElementById('counter7');
              const target = +counter7.getAttribute('data-target');
              const percentageText = ' (55%)'; // fixed text part
              let count = 0;
    ...
    <div class="col-6 col-md-4 col-lg-4 mb-3">
      <div class="card text-white text-center h-100 shadow-sm" style="background-color: #adeefd;">
        <div class="card-body">
          ...
          <h2 class="fw-bold mb-1 text-dark" id="counter11" data-target="159514831">
            0
          </h2>
