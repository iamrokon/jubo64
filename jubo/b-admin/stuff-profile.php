...
<head>
    ...
    <title>Stuff Profile | e-Learning & Earning Ltd.</title>
...
if (isset($_GET['view_id'])) {
    $id = $_GET['view_id'];
    $stmt = $con->prepare("SELECT * FROM trainer WHERE id=? AND type='stuff'");
                        ...
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <div class="page-title">
                                    ...
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item active">Stuff Profile</li>
                                    </ol>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row align-items-center" style="border-bottom: 2px dotted #ccc;">
                                            ...
                                            <div class="col-md-4 text-center mb-3">
                                                ...
                                                <img src="../stu-info/trainer_images/<?= $row['userPic'] ?>" alt="<?= $row['name'] ?>" class="img-thumbnail rounded-circle mb-3" style="width: 120px; height: 120px;">
                                        ...
                                        <div class="text-end mt-4">
                                            <a href="stuff" class="btn btn-primary">
