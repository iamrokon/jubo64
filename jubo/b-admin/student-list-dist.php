      ...
      ?>
          <tr>
           ...
           <!--  <td><?php echo $eqrow['father_name']; ?></td> -->
            ...
            <td>
              <?php
              if (!empty($incomeRow['earning_dollar'])) {
                echo '$' . number_format($incomeRow['earning_dollar'], 2);
              } else {
                echo '-';
              }
              ?>
            <td><img src="../stu-info/user_images/<?php echo $eqrow['userPic']; ?>" class="img-rounded rounded-circle" height="30px;" width="30px;"  /></td>
            <td>
			<center>
       ...
       <a class='btn btn-success btn-sm waves-effect' href='earning-information-edit?edit_id=<?= htmlspecialchars($incomeRow['in_id']) ?>'><i class='fa fa-edit me-2'></i>Edit</a>
