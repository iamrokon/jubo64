...
<body data-topbar="colored">
  ...
  if (isset($_POST['submit'])) {
    ...
    if ($stmt->execute()) {
      ...
      $student_id = $edit_row['student_id'];
      echo '<script>alert("Data Successfully Update."); window.location.href = "student-income.php?income_id=' . htmlspecialchars($student_id) . '";</script>';
      exit; // Exit after redirect
    } else {
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-md-4 text-center">
                        ...
                        ?>
                          <img src="../stu-info/user_images/<?= $eqrow['userPic'] ?>" class="img-fluid img-thumbnail rounded-circle mb-3" height="120px;" width="120px;" />
                      ...
                      <div class="col-md-5">
                        <form method="post" enctype="multipart/form-data">
                          ...
                          <a class="btn btn-danger waves-effect" href="student-income.php?income_id=<?php echo htmlspecialchars($edit_row['student_id']); ?>"><i class="fa fa-arrow-left me-2"></i>Back Now</a>
