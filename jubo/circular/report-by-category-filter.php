	...
	<div class="col-md-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<form class="form-horizontal" action="php_action/report-by-category-filter.php" method="post" id="getOrderReportForm">
		...
		<option value="#">Select Category</option>
				      	<?php 
				      	$sql = "SELECT distinct student_reg_jubo_new.district,district.dist_name FROM student_reg_jubo_new 
						left join district on district.id=student_reg_jubo_new.district order by district.dist_name asc";
			...
			<table width="100%" class="table table-bordered table-hover" customer_id="dataTables-example">
                       ...
                       <tbody id="tbody">
							...
							$sl=0;
							  ...
							  group by student_reg_jubo_new.district limit 200 ");
