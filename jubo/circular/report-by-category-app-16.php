<?php
	$con=mysqli_connect("localhost","elaeltdc_web_db","Pass@2023","elaeltdc_web_db");
...
<head>
  ...
  <title>16 - District  Student Registration Information ( E-Learning )</title>
...
where student_reg_jubo.entry_date >= '2025-03-03' AND student_reg_jubo.entry_date <= '2025-03-23' ");
$row = $sql->fetch_assoc();
$GT=$row['total'];  
?> 
				<i class="glyphicon glyphicon-user"></i> <strong> 	16 - District  Student Registration Information </strong>
			</div>
			...
			<table width="100%" class="table table-bordered table-hover" customer_id="dataTables-example">
				  ...
				  <img src="https://e-laeltd.com/jubo/project/assets/img/all/banner.jpg" width="100%" /><br>  
				  
				    লাইভ আপডেট  তথ্য - ৯ম ব্যাচ <br>
 রেজিষ্ট্রেশন চলবে  ২২ - মার্চ - ২০২৫ পর্যন্ত
					  <br>
