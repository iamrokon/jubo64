    ...
    <nav class="navbar navbar-default navbar-static-top">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li id="topNavUser"><a href="division"> <i class="glyphicon glyphicon-list"></i> Division</a></li>
          <li id="topNavUser"><a href="district"> <i class="glyphicon glyphicon-list"></i> District</a></li>
          <li id="topNavUser"><a href="jubo-student-list"> <i class="glyphicon glyphicon-user"></i> Student List</a></li>
          ...
          <li class="dropdown" id="navOrder1">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <i class="glyphicon glyphicon-print"></i> Report <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <!--<li id="topNavUser"><a href="report-by-category.php"> <i class="glyphicon glyphicon-print"></i> Report</a></li>-->
              <li id="topNavUser"><a href="report-by-category-filter.php"> <i class="glyphicon glyphicon-print"></i> Report - Filter</a></li>
              <li id="topNavUser"><a href="report-by-category-count.php"> <i class="glyphicon glyphicon-print"></i> Report Count</a></li>
            </ul>
          </li>
