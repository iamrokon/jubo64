                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="Contact" id="phone" placeholder="Phone" required>
                        ...
                        <div class="col-md-6" style="display:none;">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="Date" placeholder="<?php date_default_timezone_set("Asia/Dhaka");
                                                                                              echo date("Y/m/d"); ?>" />
                          </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            <label class="control-label">Photo</label>
                            <input class="form-control" type="file" name="user_image" id="user_image" accept="image/*" required />
                            <p>Please Upload Your Passport Size (300px X 320px) Image Here:</p>
                            <img id="image_preview" src="#" alt="Image Preview" style="display: none; width: 150px; height: auto; border: 1px solid #ccc; padding: 5px; margin-top: 10px;" />
                          </div>
                        </div>
